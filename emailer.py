...
fromaddr = "emailer@jeromeothompson.com"
...
##msg.attach(part)
print "memem"
server = smtplib.SMTP_SSL('centos.jeromeothompson.com', 465)
print "youyouyou"
#server.ehlo()
#server.starttls()
#server.ehlo()
...
for i in range(len(dirlist)):
    ...
    if(os.path.isdir(strVal) and val < 15):
	    print "you"
	    toaddr = dirlist[i] + "@jeromeothompson.com"
	    print "to", toaddr
